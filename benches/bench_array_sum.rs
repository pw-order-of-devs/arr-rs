...
pub(crate) fn array_sum_1d_1m_benchmark(c: &mut Criterion) {
    ...
    criterion.bench_function("dim: 1D, elements: 1M", |b| b.iter(|| arr.sum()));
    criterion.finish();
}
...
pub(crate) fn array_sum_1d_10m_benchmark(c: &mut Criterion) {
    ...
    criterion.bench_function("dim: 1D, elements: 10M", |b| b.iter(|| arr.sum()));
    criterion.finish();
}
...
pub(crate) fn array_sum_5d_1m_benchmark(c: &mut Criterion) {
    ...
    criterion.bench_function("dim: 5D, elements: 1M", |b| b.iter(|| arr.sum()));
    criterion.finish();
}
...
pub(crate) fn array_sum_5d_10m_benchmark(c: &mut Criterion) {
    ...
    criterion.bench_function("dim: 5D, elements: 10M", |b| b.iter(|| arr.sum()));
    criterion.finish();
}
...
pub(crate) fn array_sum_10d_1m_benchmark(c: &mut Criterion) {
    ...
    criterion.bench_function("dim: 10D, elements: 1M", |b| b.iter(|| arr.sum()));
    criterion.finish();
}
...
pub(crate) fn array_sum_10d_10m_benchmark(c: &mut Criterion) {
    ...
    criterion.bench_function("dim: 10D, elements: 10M", |b| b.iter(|| arr.sum()));
    criterion.finish();
}

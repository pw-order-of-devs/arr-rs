...
case(array_flat!(String, "abc", "cde"), array_flat!(String, "a"), array_flat!(usize, 1, 0)),
...
#[rstest(
array, sub, expected,
case(array_flat!(String, "abc", "cde"), array_flat!(String, "a"), array_flat!(bool, true, false)),
...
#[rstest(
array, sub, expected,
case(array_flat!(String, "abc", "cde"), array_flat!(String, "c"), array_flat!(bool, true, false)),
...
#[rstest(
array, sub, expected,
case(array_flat!(String, "abc", "cde"), array_flat!(String, "a"), array_flat!(isize, 0, -1)),
...
#[rstest(
array, sub, expected,
case(array_flat!(String, "abc", "cde"), array_flat!(String, "b"), array_flat!(isize, 1, -1)),

...
#[rstest(
array, expected,
case(array!(f64, [[1, 2], [3, 4]]), Ok(vec![array_flat!(f64, 5.379562043795623, -0.3795620437956202).unwrap()])),
...
case(array!(f64, [[12., -51., 4.], [6., 167., -68.], [-4., 24., -41.]]), Ok(vec![array_flat!(f64, 156.20350762022628, -35.47324460887994, 17.269736988653587).unwrap()])),
...
array_flat!(f64, 5.379562043795623, -0.3795620437956202).unwrap(),
...
array_flat!(f64, 156.20350762022628, -35.47324460887994, 17.269736988653587).unwrap(),
array!(f64, [[0.3274744043621115, 0.27410439425327837, -0.9929229419852036], [-0.9370666300603048, 0.30401450841284644, 0.08536232642252142], [-0.12110592601150547, 0.9123825731158715, 0.08256696983166305]]).unwrap(),
)])),
case(array!(f64, [1, 4, 3]), Err(ArrayError::UnsupportedDimension { supported: vec![0, 1] })),
case(array!(f64, [[1, 4, 3], [3, 2, 4]]), Err(ArrayError::MustBeEqual { value1: "2".to_string(), value2: "3".to_string() })),
